Ext.define('cn.incontent.locator.AuthoritySearcher', {
	...
	getSelectedTpl : function() {
		if (!this.selectedTpl) {
			this.selectedTpl = new Ext.XTemplate('<tpl for="."><table style="width:100%"><tr><td><sec class="{TYPE:this.getAuthIconCls}"></sec>{authDisplayName}</td><td align=right><img idx={#} title="' + Utils.msg('MSG_DELETE') + '" src="images/bin.png" /></td></tr></table></tpl>', {
				getAuthIconCls : this.getAuthIconCls
			});
		}
