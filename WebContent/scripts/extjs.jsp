...
<script type="text/javascript" src="<%=request.getContextPath() %>/jslib/extjs/ext-all.js"></script>
<script type="text/javascript" src="<%=request.getContextPath() %>/jslib/extjs/ext-theme-neptune.js"></script>
<script type="text/javascript" src="<%=request.getContextPath() %>/jslib/extjs/patch.js"></script>
...
(function() {
	...
	Ext.Loader.setConfig({
		paths : {
			Ext : '<%=request.getContextPath() %>/jslib/extjs/src-min',
			locale : '<%=request.getContextPath() %>/jslib/extjs/locale',
			lib : '<%=request.getContextPath() %>/jslib'
		}
	});
