...
<%@page import="cn.incontent.i18n.utils.I18NLocal" %>
...
<script type="text/javascript" src="${basePath}jslib/jquery/extends/jquery-ui-effect.js"></script>
<script type="text/javascript" src="${basePath}jslib/nprogress/nprogress.js"></script>

<script>
var CSSLIB = ['css/login', 'css/application', 'css/nprogress'];
</script>
	...
	<div align=center style='padding-top:100px;'>
		<form id="loginform" accept-charset="UTF-8" method="post" autocomplete="off">
		   	<table id='login' class='login-panel' cellspacing="6">
		   		<tr><td class='line' align=center style='height:110px;'><img class='logo' src='images/logo.png' /></td></tr>
...
<script type="text/javascript">
    ...
    function login() {
        ...
        Ext.get('login-info').dom.innerHTML = '<span style="color:#3333ff;">' + Utils.msg('MSG_WAIT') + '</span>&nbsp;<img src="' + base + 'images/loading.gif" />';
